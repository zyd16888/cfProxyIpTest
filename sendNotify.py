...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="send message for Notify.")
    parser.add_argument("-t", "--title", type=str, help="message title", required=False)
    parser.add_argument("-c", "--content", type=str, help="message content", required=False)
    args = parser.parse_args()
    if args.title and args.content:
        send(args.title, args.content)
    else:
        main()
